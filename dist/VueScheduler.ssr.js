...
var __vue_module_identifier__ = "data-v-96ca56b6";
/* functional template */
...
var __vue_render__$1 = function __vue_render__() {
  ...
  return _c('div', {
    ...
    return "<div class=\"day-column\"><div class=\"day-column-weekday\">" + _vm._ssrEscape("\n                " + _vm._s(day.format('ddd')) + "\n            ") + "</div> <div class=\"day-column-day\"><button" + _vm._ssrClass(null, day.isSame(_vm.now, 'day') ? 'day-column-button day-column-button-today' : 'day-column-button') + "><span class=\"day-column-button-content\">" + _vm._ssrEscape(_vm._s(day.format('D'))) + "</span></button></div> <div class=\"day-column-fill\">" + _vm._ssrList(_vm.users, function (user) {
...
var __vue_module_identifier__$1 = "data-v-215949e4";
/* functional template */
...
var __vue_render__$2 = function __vue_render__() {
  ...
  }, [_vm._ssrNode("<div class=\"body-day-user-event-text\"><div class=\"body-day-user-event-name\">" + _vm._ssrEscape(_vm._s(_vm.event.name)) + "</div> <div class=\"body-day-user-event-timings\">" + _vm._ssrEscape(" " + _vm._s(_vm.generatePrettyTimings(_vm.event)) + " ") + "</div> <div class=\"body-day-user-event-description-text\">" + _vm._ssrEscape(_vm._s(_vm.event.description)) + "</div></div>")]);
};
...
var __vue_module_identifier__$2 = "data-v-8c6bf676";
/* functional template */
...
var __vue_render__$3 = function __vue_render__() {
  ...
  return _c('div', {
    ...
    return "<div class=\"body-day-user-column no-select\">" + _vm._ssrList(_vm.hours, function (hour) {
      return "<div" + _vm._ssrClass(null, hour.onHour ? 'day-increment on-hour' : 'day-increment') + _vm._ssrStyle(null, 'height: ' + _vm.incrementHeight + 'px;', null) + "></div>";
...
var __vue_module_identifier__$3 = "data-v-093482ff";
/* functional template */
...
var script$4 = {
  ...
  mounted: function mounted() {
    ...
    this.setDays();
    axios.get('/appointments?filter[date]=2020-04-11').then(function (response) {
...
var __vue_module_identifier__$4 = "data-v-7bcfb8f8";
/* functional template */
